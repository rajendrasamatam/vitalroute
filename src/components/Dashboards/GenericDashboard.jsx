...
const GenericDashboard = ({
    ...
    const [activeView, setActiveView] = useState(searchParams.get('tab') || 'overview');

    // Sync activeView to URL search params
    useEffect(() => {
    ...
    // Location Permission Request for Field Units
    useEffect(() => {
        if (roleId && roleId !== 'admin' && 'geolocation' in navigator) {
